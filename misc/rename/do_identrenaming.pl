...
if ($operation ne "incomments" && $operation ne "incode" && $operation ne "filename" && $operation ne "everywhere") {
    print STDERR "usage: do_identrenaming listfile mappingfile (incomments|incode|filename|everywhere)\n";
    exit(1);
}
