...
void SCTPNatPeer::handleTimer(cMessage *msg)
{
   ...
   switch (msg->getKind())
   {
      case MSGKIND_CONNECT:
         ...
         connect(IPvXAddressResolver().resolve(par("connectAddress").stringValue(), 1),par("connectPort").longValue());
         delete msg;
         break;
      case SCTP_C_SEND:
...
void SCTPNatPeer::socketEstablished(int32, void *)
{
   ...
   if (rendezvous)
   {
      ...
      msg->setPeer1(par("ownName").longValue());
      msg->setPeer1AddressesArraySize(1);
      msg->setPeer1Addresses(0,IPvXAddress("0.0.0.0"));
      msg->setPortPeer1(par("port").longValue());
      msg->setPeer2(par("peerName").longValue());
...
void SCTPNatPeer::addressAddedArrived(int32 assocId, IPvXAddress localAddr, IPvXAddress remoteAddr)
{
   ...
   if (rendezvous)
   {
      ...
      msg->setPortPeer1(par("port").boolValue());
      msg->setPeer2(par("peerName").longValue());
