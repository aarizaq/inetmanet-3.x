...
#ifndef __INET_TCPGENERICCLIAPPBASEPROMIS_H
#define __INET_TCPGENERICCLIAPPBASEPROMIS_H
 ...
 */
class INET_API TCPGenericCliAppBasePromis : public cSimpleModule,public INotifiable, public TCPSocket::CallbackInterface
{
  protected:
    TCPSocket socket;
