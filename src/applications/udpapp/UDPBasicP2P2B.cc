...
void UDPBasicP2P2B::receiveChangeNotification(int category, const cObject *details)
{
    Enter_Method_Silent();
}
...
IPvXAddress UDPBasicP2P2B::chooseDestAddrBurst()
{
...
void UDPBasicP2P2B::generateBurst()
{
    ...
    UDPBasicP2P2B::DirectAddres::iterator it = directAddress.find(destAddr.get4());
...
ManetAddress UDPBasicP2P2B::DelayMessage::getNodeId() const
{
    return nodeId_var;
}

void UDPBasicP2P2B::DelayMessage::setNodeId(ManetAddress nodeId)
{
    this->nodeId_var = nodeId;
}

ManetAddress UDPBasicP2P2B::DelayMessage::getDestination() const
{
    return destination_var;
}

void UDPBasicP2P2B::DelayMessage::setDestination(ManetAddress destination)
{
