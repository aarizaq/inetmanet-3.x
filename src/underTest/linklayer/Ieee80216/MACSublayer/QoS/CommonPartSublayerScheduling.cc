...
#else
        IPv4Datagram* upper_ipd = check_and_cast<IPv4Datagram*>(upper_msg->getEncapsulatedMsg());
#endif
...
#else
            IPv4Datagram* upper_ipd = check_and_cast<IPv4Datagram*>(tmp_msg->getEncapsulatedMsg());
#endif
            Ieee80216TGControlInformation* ipd_control =
                check_and_cast<Ieee80216TGControlInformation*>(upper_ipd->getControlInfo());
