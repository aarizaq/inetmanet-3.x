...
public:
	 ...
	 */
	virtual int compareRstpVector(RSTPQ1Vector vect2);
};
...
public:
	...
	RSTPQ1Vector PortRstpVector;	//best received RSTPvector in that port.
 ...
 * RSTP implementation.
 */
class RSTP1Q: public cSimpleModule
{
  protected:
	  /*Dynamic data.*/
  ...
  protected:
	 ...
	 */
	virtual RSTPQ1Vector getRootRstpVector();
	 ...
	 * -4=Worse Port -3=Worse Src -2=Worse RPC -1=Worse   0= Similar  1=Better Root. 2= Better RPC  3= Better Src   4= Better Port
	 */
	virtual int contestRstpVector(RSTPQ1Vector vect2,int v2Port);
