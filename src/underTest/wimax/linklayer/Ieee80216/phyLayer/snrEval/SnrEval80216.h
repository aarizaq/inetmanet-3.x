 ...
 * @ingroup snrEval
 */
class INET_API SnrEval80216 : public BasicSnrEval
{
  public:
    SnrEval80216();
  ...
  protected:
    ...
    cOutVector recSendPowVec;
    cOutVector recRecievPowVec;
    cOutVector recRecievSNRVec;
    cOutVector recXcorVec;
    cOutVector recYcorVec;
    cOutVector recDistBVec;
};
