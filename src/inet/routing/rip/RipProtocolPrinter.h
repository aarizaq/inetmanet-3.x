...
#ifndef __INET_RIPPROTOCOLPRINTER_H
#define __INET_RIPPROTOCOLPRINTER_H
...
class INET_API RipProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_ICMPPROTOCOLPRINTER_H
