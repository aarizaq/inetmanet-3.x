...
#ifndef _SAMPHO_ROUTINGTABLE_H
#define _SAMPHO_ROUTINGTABLE_H
...
/*****************************************************************************************
 * class SDDYMO_RoutingTable: Describes the extended functionality of the SDDYMO routing
 *                            table.
 *****************************************************************************************/
class SAMPhO_RoutingTable : public SAORSBase_RoutingTable
{
	protected:
	...
	public:
		...
		SAMPhO_RoutingTable(cObject* host, const IPv4Address& myAddr);

		/** @brief class destructor */
		virtual ~SAMPhO_RoutingTable();
		...
		/** @brief returns the number of the neighbors to be considered as strangers */
		virtual uint getNumOfStrangers();
		...
		/** @brief returns whether a certain routing entry describes a stranger to the current node or not */
		virtual bool isStranger(const SAORSBase_RoutingEntry *entry);
