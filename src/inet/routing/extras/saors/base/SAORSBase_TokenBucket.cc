 ...
 * Class Constructor
 ********************************************************************************************/
SAORSBase_TokenBucket::SAORSBase_TokenBucket(double tokensPerTick, double maxTokens, simtime_t currentTime) : tokensPerTick(tokensPerTick), maxTokens(maxTokens), availableTokens(maxTokens), lastUpdate(currentTime) {
}


/********************************************************************************************
 * Consumes the initial tokens assigned from the constuctor.
 ********************************************************************************************/
bool SAORSBase_TokenBucket::consumeTokens(double tokens, simtime_t currentTime) {
