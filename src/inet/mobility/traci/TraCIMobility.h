 ...
 */
namespace inet {
class TraCIMobility : public LineSegmentsMobilityBase
{
	public:
		class Statistics {
			public:
		...
		TraCIMobility() : LineSegmentsMobilityBase(), isPreInitialized(false), manager(0), commandInterface(0), vehicleCommandInterface(0) {}
		~TraCIMobility() {
