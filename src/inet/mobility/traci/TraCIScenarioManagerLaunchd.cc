...
#include "inet/mobility/traci/TraCIScenarioManagerLaunchd.h"
#include "inet/mobility/traci/TraCICommandInterface.h"
#include "inet/mobility/traci/TraCIConstants.h"
...
inet::TraCIScenarioManagerLaunchd* TraCIScenarioManagerLaunchdAccess::get() {
