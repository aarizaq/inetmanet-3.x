...
#ifndef __INET_TCPPROTOCOLPRINTER_H
#define __INET_TCPPROTOCOLPRINTER_H
...
class INET_API TcpProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_UDPPROTOCOLPRINTER_H
