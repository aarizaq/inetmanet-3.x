...
#ifndef NS_PORT
#include "inet/neta/hackedmodules/networklayer/manetrouting/aodv/NA_aodv-uu/NA_timer_queue_aodv.h"
#endif

#ifdef NS_PORT
#define NS_CLASS NA_AODVUU::
...
struct dev_info
{
    ...
    struct inetmanet::in_addr ipaddr;  /* The local IP address */
    struct inetmanet::in_addr netmask; /* The netmask we use */
    struct inetmanet::in_addr broadcast;
};
