...
#include "inet/neta/attacks/controllers/droppingAttack/NA_DroppingAttack.h"
...
Define_Module (NA_DroppingAttack);

cMessage *NA_DroppingAttack::generateAttackMessage(const char *name) {
