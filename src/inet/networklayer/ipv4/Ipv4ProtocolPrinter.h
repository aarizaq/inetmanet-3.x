...
#ifndef __INET_IPV4PROTOCOLPRINTER_H
#define __INET_IPV4PROTOCOLPRINTER_H
...
class INET_API Ipv4ProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_IPV4PROTOCOLPRINTER_H
