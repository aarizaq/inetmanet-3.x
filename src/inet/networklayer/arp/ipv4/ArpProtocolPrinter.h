...
#ifndef __INET_ARPPROTOCOLPRINTER_H
#define __INET_ARPPROTOCOLPRINTER_H
...
class INET_API ArpProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_ARPPROTOCOLPRINTER_H
