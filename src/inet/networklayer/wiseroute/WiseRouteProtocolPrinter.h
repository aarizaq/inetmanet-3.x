...
#ifndef __INET_WISEROUTEPROTOCOLPRINTER_H
#define __INET_WISEROUTEPROTOCOLPRINTER_H
...
class INET_API WiseRouteProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_WISEROUTEPROTOCOLPRINTER_H
