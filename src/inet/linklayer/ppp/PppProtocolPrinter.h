...
#ifndef __INET_PPPPROTOCOLPRINTER_H
#define __INET_PPPPROTOCOLPRINTER_H
...
class INET_API PppProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_PPPPROTOCOLPRINTER_H
