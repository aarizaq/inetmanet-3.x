...
#ifndef __INET_CSMACAMACPROTOCOLPRINTER_H
#define __INET_CSMACAMACPROTOCOLPRINTER_H
...
class INET_API CsmaCaMacProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_CSMACAMACPROTOCOLPRINTER_H
