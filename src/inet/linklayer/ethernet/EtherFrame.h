...
class EtherPhyFrame : public EtherPhyFrame_Base
{
  ...
  public:
    ...
    virtual const char *getDisplayString() const override { return hasEncapsulatedPacket() ? const_cast<EtherPhyFrame *>(this)->_getEncapMsg()->getDisplayString() : EtherPhyFrame_Base::getDisplayString(); }
};
