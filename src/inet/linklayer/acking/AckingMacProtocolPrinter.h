...
#ifndef __INET_ACKINGMACPROTOCOLPRINTER_H
#define __INET_ACKINGMACPROTOCOLPRINTER_H
...
class INET_API AckingMacProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif // __INET_ACKINGMACPROTOCOLPRINTER_H
