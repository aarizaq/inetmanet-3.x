...
class INET_API SCTPMessage : public SCTPMessage_Base
{
   ...
   public:
      ...
      virtual void setChunksArraySize(const uint32 size);

      /** Generated but unused method, should not be called. */
      virtual void setChunks(const uint32 k, const cPacketPtr& chunks_var);
      ...
      /**
        ...
        */
      virtual cPacketPtr& getChunks(const uint32 k);
