...
// moved to Ieee802154Phy.h
//const uint16_t aMaxBeaconOverhead             = 75;       //max # of octets added by the MAC sublayer to the payload of its beacon frame
//const uint16_t aMaxBeaconPayloadLength = aMaxPHYPacketSize - aMaxBeaconOverhead;       //max size, in octets, of a beacon payload
const uint16_t MaxBeaconPayloadLength = 256;

const uint16_t aGTSDescPersistenceTime            = 4;        //# of superframes that a GTS descriptor exists in the beacon frame of a PAN coordinator
// moved to Ieee802154Phy.h
